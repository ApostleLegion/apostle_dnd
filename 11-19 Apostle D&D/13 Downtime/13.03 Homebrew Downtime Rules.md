...
Specific Item: Tomes and Manuals. A player may only use 2 of these items until level 20 at which a ruling will be made for the use of these items again. 
...
## Backstory Downtimes
This is a biweekly opportunity that replaces two downtimes. With this downtime activity, players may ask for a regular downtime activity but connect it with their backstory. 

`For example: 
?Name of Character: Delta
Guild Affiliation: N/A
Requested Activity: Backstory (bounty)
Requested DM: Any
Place for RP: Beacon`

The rewards will be the same per regular downtime activity but will build more of a story for a PC. Backstory Downtimes can only be requested by players who are level seven and higher.
